...
(function (lightSwitchApplication) {
    ...
    msls._addToNamespace("msls.application", {
        ...
        ApplicationData: $defineDataService(ApplicationData, lightSwitchApplication.rootUri + "/ApplicationData.svc", [
            ...
            {
                name: "SortedContacts", value: function () {
                    return new $DataServiceQuery({ _entitySet: this.Contacts },
                        lightSwitchApplication.rootUri + "/ApplicationData.svc" + "/SortedContacts()",
                        {
                        });
                }
            },
            {
                name: "ContactsByBirthDate", value: function (MinimumBirthDate, MaximumBirthDate) {
                    return new $DataServiceQuery({ _entitySet: this.Contacts },
                        lightSwitchApplication.rootUri + "/ApplicationData.svc" + "/ContactsByBirthDate()",
                        {
                            MinimumBirthDate: $toODataString(MinimumBirthDate, "DateTime?"),
                            MaximumBirthDate: $toODataString(MaximumBirthDate, "DateTime?")
                        });
                }
            },
            {
                name: "ContactsByPhone", value: function (FindContact) {
                    return new $DataServiceQuery({ _entitySet: this.PhoneNumbers },
                        lightSwitchApplication.rootUri + "/ApplicationData.svc" + "/ContactsByPhone()",
                        {
                            FindContact: $toODataString(FindContact, "String?")
                        });
                }
            }
        ]),
