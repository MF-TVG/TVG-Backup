<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Form4610RList.ascx.cs" Inherits="USAACE.eStaffing.Web.Controls.ListControls.Form4610RList" %>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td class="left">
                        ...
                        <div><span class="label required">Unit Designation:</span> <asp:Literal runat="server" ID="ltrUnit" /></div>
                    </td>
                    <td class="left">
