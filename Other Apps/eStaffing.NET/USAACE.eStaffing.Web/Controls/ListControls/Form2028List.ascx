<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Form2028List.ascx.cs" Inherits="USAACE.eStaffing.Web.Controls.ListControls.Form2028List" %>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td class="left">
                        ...
                        <div><span class="label required">Lesson ID:</span> <asp:Literal runat="server" ID="ltrLessonID" /></div>
                        <div><span class="label required">Course Number:</span> <asp:Literal runat="server" ID="ltrCourseNumber" /></div>
                    </td>
                    <td class="left">
