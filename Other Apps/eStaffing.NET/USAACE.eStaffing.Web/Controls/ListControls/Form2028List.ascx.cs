...
{
    public partial class Form2028List : FormListControl, IForm2028ListView
    {
        /// <summary>
        /// Private member for the presenter
        /// </summary>
        private Form2028ListPresenter _presenter;

        /// <summary>
        /// The presenter for this view
        /// </summary>
        public Form2028ListPresenter Presenter
        {
            get
            {
                if (_presenter == null)
                {
                    _presenter = new Form2028ListPresenter(this);
                }
        ...
        protected void dlFormList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            try
            {
                if (e.Item.DataItem is Form)
                {
                    ...
                    Form2028 form2028 = form.ExtendedProperties.FormData as Form2028;
                    ...
                    (e.Item.FindControl("ltrLessonID") as Literal).Text = form2028.LessonID;
                    ...
                    (e.Item.FindControl("ltrCourseNumber") as Literal).Text = form2028.CourseNumber;
