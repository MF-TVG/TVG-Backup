<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TDYSheetList.ascx.cs" Inherits="USAACE.eStaffing.Web.Controls.ListControls.TDYSheetList" %>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td class="left">
                        ...
                        <div><span class="label required">Purpose:</span> <asp:Literal runat="server" ID="ltrPurpose" /></div>
                    </td>
                    <td class="left">
