...
{
    public partial class Form4610RList : FormListControl, IForm4610RListView
    {
        /// <summary>
        /// Private member for the presenter
        /// </summary>
        private Form4610RListPresenter _presenter;

        /// <summary>
        /// The presenter for this view
        /// </summary>
        public Form4610RListPresenter Presenter
        {
            get
            {
                if (_presenter == null)
                {
                    _presenter = new Form4610RListPresenter(this);
                }
        ...
        protected void dlFormList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            try
            {
                if (e.Item.DataItem is Form)
                {
                    ...
                    Form4610R form4610r = form.ExtendedProperties.FormData as Form4610R;
                    ...
                    (e.Item.FindControl("ltrTitle") as Literal).Text = form4610r.Title;
                    ...
                    (e.Item.FindControl("ltrUnit") as Literal).Text = form4610r.Unit;
