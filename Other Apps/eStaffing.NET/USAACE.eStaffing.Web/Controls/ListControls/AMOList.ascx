<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AMOList.ascx.cs" Inherits="USAACE.eStaffing.Web.Controls.ListControls.AMOList" %>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td class="left">
                        ...
                        <div><span class="label required">Issues:</span> <asp:Literal runat="server" ID="ltrIssues" /></div>
                    </td>
                    <td class="left">
                        <div><span class="label required">Submit Date:</span> <asp:Literal runat="server" ID="ltrSubmitDate" /></div>
                        <div><span class="label required">AMO Date:</span> <asp:Literal runat="server" ID="ltrDate" /></div>
