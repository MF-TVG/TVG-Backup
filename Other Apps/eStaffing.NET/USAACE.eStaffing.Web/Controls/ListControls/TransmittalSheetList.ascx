<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TransmittalSheetList.ascx.cs" Inherits="USAACE.eStaffing.Web.Controls.ListControls.TransmittalSheetList" %>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td class="left">
                        ...
                        <div><span class="label required">Recommendation:</span> <asp:Literal runat="server" ID="ltrRecommendation" /></div>
                    </td>
                    <td class="left">
