...
{
    public class AMOListPresenter : BasePresenter
    {
        /// <summary>
        /// The IAMOListView for the AMOListPresenter
        /// </summary>
        private new IAMOListView View
        {
            get
            {
                return base.View as IAMOListView;
            }
        }
        ...
        public AMOListPresenter(IAMOListView view)
        {
            base.View = view;
        }
        ...
        public void Load()
        {
            ...
            if (startIndex >= 0)
            {
                ...
                for (Int32 i = startIndex; i < startIndex + this.View.IncrementRange && i < forms.Count; i++)
                {
                    ...
                    {
                        form.ExtendedProperties.FormData = FormDataUtil.LoadSpecificFormData<AMOForm>(formDatas[form.FormID]);
