...
{
    public class SchoolsRequestListPresenter : BasePresenter
    {
        /// <summary>
        /// The ISchoolsRequestListView for the SchoolsRequestListPresenter
        /// </summary>
        private new ISchoolsRequestListView View
        {
            get
            {
                return base.View as ISchoolsRequestListView;
            }
        }

        /// <summary>
        /// Constructor accepting an instance of the ISchoolsRequestListView
        /// </summary>
        /// <param name="view">The ISchoolsRequestListView</param>
        public SchoolsRequestListPresenter(ISchoolsRequestListView view)
        {
            base.View = view;
        }
        ...
        public void Load()
        {
            ...
            if (startIndex >= 0)
            {
                ...
                for (Int32 i = startIndex; i < startIndex + this.View.IncrementRange && i < forms.Count; i++)
                {
                    ...
                    {
                        form.ExtendedProperties.FormData = FormDataUtil.LoadSpecificFormData<SchoolsRequest>(formDatas[form.FormID]);
