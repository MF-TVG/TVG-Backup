...
{
    public class TaskingListPresenter : BasePresenter
    {
        /// <summary>
        /// The ITaskingListView for the TaskingListPresenter
        /// </summary>
        private new ITaskingListView View
        {
            get
            {
                return base.View as ITaskingListView;
            }
        }

        /// <summary>
        /// Constructor accepting an instance of the ITaskingListView
        /// </summary>
        /// <param name="view">The ITaskingListView</param>
        public TaskingListPresenter(ITaskingListView view)
        {
            base.View = view;
        }
        ...
        public void Load()
        {
            ...
            if (startIndex >= 0)
            {
                ...
                for (Int32 i = startIndex; i < startIndex + this.View.IncrementRange && i < forms.Count; i++)
                {
                    ...
                    {
                        form.ExtendedProperties.FormData = FormDataUtil.LoadSpecificFormData<Tasking>(formDatas[form.FormID]);
