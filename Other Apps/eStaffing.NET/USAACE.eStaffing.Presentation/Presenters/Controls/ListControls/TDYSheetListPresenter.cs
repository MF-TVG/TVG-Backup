...
{
    public class TDYSheetListPresenter : BasePresenter
    {
        /// <summary>
        /// The ITDYSheetListView for the TDYSheetListPresenter
        /// </summary>
        private new ITDYSheetListView View
        {
            get
            {
                return base.View as ITDYSheetListView;
            }
        }

        /// <summary>
        /// Constructor accepting an instance of the ITDYSheetListView
        /// </summary>
        /// <param name="view">The ITDYSheetListView</param>
        public TDYSheetListPresenter(ITDYSheetListView view)
        {
            base.View = view;
        }
        ...
        public void Load()
        {
            ...
            if (startIndex >= 0)
            {
                ...
                for (Int32 i = startIndex; i < startIndex + this.View.IncrementRange && i < forms.Count; i++)
                {
                    ...
                    {
                        form.ExtendedProperties.FormData = FormDataUtil.LoadSpecificFormData<TDYSheet>(formDatas[form.FormID]);
