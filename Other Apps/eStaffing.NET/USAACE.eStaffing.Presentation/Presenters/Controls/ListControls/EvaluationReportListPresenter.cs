...
{
    public class EvaluationReportListPresenter : BasePresenter
    {
        /// <summary>
        /// The IAwardsSheetListView for the AwardsSheetListPresenter
        /// </summary>
        private new IEvaluationReportListView View
        {
            get
            {
                return base.View as IEvaluationReportListView;
            }
        }

        /// <summary>
        /// Constructor accepting an instance of the IEvaluationReportListView
        /// </summary>
        /// <param name="view">The IEvaluationReportListView</param>
        public EvaluationReportListPresenter(IEvaluationReportListView view)
        {
            base.View = view;
        }
        ...
        public void Load()
        {
            ...
            if (startIndex >= 0)
            {
                ...
                for (Int32 i = startIndex; i < startIndex + this.View.IncrementRange && i < forms.Count; i++)
                {
                    ...
                    {
                        form.ExtendedProperties.FormData = FormDataUtil.LoadSpecificFormData<EvaluationReport>(formDatas[form.FormID]);
